...
local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/shlexware/Rayfield/refs/heads/main/source"))()
local Window = redzlib:MakeWindow({ Title = "Xyris Hub : Meme Sea", SubTitle = "by Xyris Hub Team, SaveFolder = "xyris-MemeSea.json" })
Window:AddMinimizeButton({
  Button = { Image = "rbxassetid://105778388057716", BackgroundTransparency = 0 },
...
local _Discord = Tabs.Discord do
  _Discord:AddDiscordInvite({
    Name = "Xyris Scripts | Community",
    Description = "Join our discord community to receive information about the next update",
    Logo = "rbxassetid://105778388057716",
    Invite = "https://discord.gg/3WtS2F7CaX"
  })
end
